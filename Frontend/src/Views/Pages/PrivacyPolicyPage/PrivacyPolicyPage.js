        ...
        <Container>
          ...
          <div className="lvl-1">
            ...
            <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
              ...
              maintained
              by the <a href="https://www.privacypolicies.com/privacy-policy-generator/">Privacy Policy Generator</a>.
            </p>
          </div>
          ...
          <div className="lvl-2">
            ...
            <ul>
              ...
              <li><strong>Website</strong> refers to Garder Le Cap, accessible from https://garderlecap.global/</li>
          ...
          <div><h3>Tracking Technologies and Cookies</h3></div>
          <div className="lvl-3">
            ...
            <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on your personal computer
              ...
              browser.
              Learn more about cookies in the <a href="https://www.privacypolicies.com/blog/cookies/">"What Are
                Cookies"</a> article.</p>
          ...
          <div className="lvl-2">
            ...
            <ul>
              ...
              <li><strong>With other users:</strong> when You share personal information or otherwise interact in the
                ...
                contacts on the Third-Party Social Media Service may see You name, profile, pictures and description
                of
          ...
          <div><h3>Business Transactions</h3></div>
          <div className="lvl-3">
          ...
          <div><h3>Other legal requirements</h3></div>
          <div className="lvl-3">
          ...
          <div className="lvl-1">
            ...
            <ul>
              <li>By email: info@garderlecap.global</li>
            </ul>
          </div>
        </Container>
      </div>
